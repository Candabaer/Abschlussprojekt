...
- Create Angular project with ng: `ng new abschlussprojekt.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`abschlussprojekt.client.esproj`).
